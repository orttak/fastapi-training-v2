...
For different module, it is better to define different confest.py file. Because if you define all fixtures in one file, it will be hard to understand which fixture is used for which module.
'''
...
def test_posts(test_user, test_user2, session):
    post_data = [{"title": "test_post", "content": "test_content", "owner_id": test_user["id"]},
                 {"title": "test_post2", "content": "test_content2",
                     "owner_id": test_user["id"]},
                 {"title": "test_post3", "content": "test_content3",
                     "owner_id": test_user["id"]},
